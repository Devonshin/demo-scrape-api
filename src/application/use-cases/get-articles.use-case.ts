...
import {GetArticlesQuery, GetArticlesResult, GetArticlesPort,} from '../ports/in/get-articles.port';
import {ArticleFilterOptions, ArticleRepositoryPort} from '../ports/out/repositories/article.repository.port';
 ...
 */
@Injectable()
export class GetArticlesUseCase implements GetArticlesPort {
