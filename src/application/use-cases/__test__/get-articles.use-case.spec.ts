...
import {ArticleRepositoryPort, PaginatedArticles} from '../../ports/out/repositories/article.repository.port';
import {GetArticlesQuery} from '../../ports/in/get-articles.port';
...
describe('GetArticlesUseCaseImpl', () => {
  ...
  let mockArticleRepository: jest.Mocked<ArticleRepositoryPort>;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<GetArticlesUseCase>(GetArticlesUseCase);
  });
